"""Markdown writer for the Phase 9 executive report.
...
inline by Streamlit, (b) saved as a .md file and viewed in any
...
from app.reporting.executive.sections import ReportDocument, Severity
