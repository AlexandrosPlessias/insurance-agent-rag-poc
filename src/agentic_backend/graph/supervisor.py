...
from agentic_backend.audit.middleware import current_trace_id, record as audit_record
...
# a year. The memory loader caps history at ~6 messages anyway.
_HISTORY_LOOKBACK = 6
...
def supervisor_node(state: GraphState) -> dict:
    ...
    # Clarifier follow-up: if the immediately-prior assistant
    ...
    with tracer.start_as_current_span("supervisor.classify") as span, \
        ...
        #    year is exactly the case the year-aware routing handles.
